...
// User
$remote_user_dev     = 'credendod9';

// Alias
$aliases[$project . '.dev'] = array(
    'root'                    => '/var/www/customprojects_D8/credendod9/dev/docroot',
    'php' => '/opt/php/7.4/php', //ansible generated for dev, do not remove
    'path-aliases'            => array(
...
// staging
// Server
$env_staging     = 'web-011.dropsolid.com';
// User
$remote_user_staging     = 'credendod9_staging';

// Alias
$aliases[$project . '.staging'] = array(
    'root'                    => '/var/www/credendod9/staging/application/docroot',
    'php' => '/opt/php/7.4/php', //ansible generated for staging, do not remove
    'path-aliases'            => array(
...
// live
// Server
$env_live     = 'web-028.dropsolid.com';
// User
$remote_user_live     = 'credendod9_live';

// Alias
$aliases[$project . '.live'] = array(
    'root'                    => '/var/www/credendod9/live/application/docroot',
    'php' => '/opt/php/7.4/php', //ansible generated for live, do not remove
    'path-aliases'            => array(
